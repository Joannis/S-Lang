...
print(Parser("/Users/joannisorlandos/Documents/SLang/code/main.vs").parse())
...
//shell(path: getClangPath(), args: ["-o", "/Users/joannisorlandos/Documents/SLang/code/testexec", object])
